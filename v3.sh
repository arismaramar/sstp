...
function notif_bot() {
    ...
    USRSC=$(curl https://raw.githubusercontent.com/arismaramar/izinkansaya/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/arismaramar/izinkansaya/main/ip | grep $ipsaya | awk '{print $3}')
    TIMES=`date -d "0 days" +"%d-%m-%Y" `
    TIMEZONE=$(printf '%(%H:%M:%S)T')
    TEXT="
<code>────────────────────</code>
<b>    AUTOSCRIPT ANGGUN   </b>
<code>────────────────────</code>
...
<i>TekiroVpn</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER SC","url":"https://t.me/amantubilah"},{"text":"CONTACK","url":"https://wa.me/6285365581599"}]]}'
