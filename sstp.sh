...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/allow > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/allow | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/allow | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/allow | lolcat
echo "SSTP" | lolcat
...
touch /var/lib/anggunstore/data-user-sstp
...
curl -sS "https://autosscript.site/sstp/accel.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/accel-ppp.conf
...
#input perintah sstp
wget -q -O /usr/local/sbin/addsstp "https://raw.githubusercontent.com/arismaramar/sstp/main/addsstp.sh " && chmod +x /usr/local/sbin/addsstp
wget -q -O /usr/local/sbin/delsstp "https://raw.githubusercontent.com/arismaramar/sstp/main/delsstp.sh" && chmod +x /usr/local/sbin/delsstp
wget -q -O /usr/local/sbin/ceksstp "https://raw.githubusercontent.com/arismaramar/sstp/main/ceksstp.sh" && chmod +x /usr/local/sbin/ceksstp
wget -q -O /usr/local/sbin/renewsstp "https://raw.githubusercontent.com/arismaramar/sstp/main/renewsstp.sh" && chmod +x /usr/local/sbin/renewsstp
wget -q -O /usr/local/sbin/trialsstp "https://raw.githubusercontent.com/arismaramar/sstp/main/trialsstp.sh" && chmod +x /usr/local/sbin/trialsstp
wget -q -O /usr/local/sbin/portsstp "https://raw.githubusercontent.com/arismaramar/sstp/main/portsstp.sh" && chmod +x /usr/local/sbin/portsstp
wget -q -O /usr/local/sbin/sstp-menu "https://raw.githubusercontent.com/arismaramar/sstp/main/sstp-menu.sh" && chmod +x /usr/local/sbin/sstp-menu
